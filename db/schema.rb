...
ActiveRecord::Schema.define(version: 20140407033357) do
  ...
  add_index "social_networks", ["short_name"], name: "index_social_networks_on_short_name", unique: true, using: :btree
